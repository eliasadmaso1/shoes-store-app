...
export default function Accessories() {
  ...
  return (
  <div className={mobile ? "accessories-Container-media" : "accessories-Container"}>
      <div className={mobile ? "accessories-btn-media" : "accessories-btn"}>
      ...
      <div className={mobile ? "background-media" : "background"}>
